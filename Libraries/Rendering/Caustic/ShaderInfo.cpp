            ...
            if (bstrName == L"Field")
            {
                ...
                for (long j = 0; j < numAttribs; j++)
                {
                    ...
                    if (attribName == L"Semantic")
                    {
                        ...
                        // These are auto-generated by the GPU, not from vertex buffers.
                        // SV_POSITION is allowed since it's part of the vertex layout.
                        if (str.substr(0, 3) == "SV_" && str != "SV_POSITION")
                        {
                            isSystemValue = true;
                            break;
                        }
