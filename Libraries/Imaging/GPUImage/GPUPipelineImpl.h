...
namespace Caustic
{
    ...
    {
        CComPtr<ID3D12Resource> m_spSourceImage;
    public:
    ...
    class CGPUPipeline : public IGPUPipeline, public CRefCount
    {
        ...
        CComPtr<ID3D12Resource> m_spFullQuadVB;
        CComPtr<ID3D12Resource> m_spFullQuadIB;
    ...
    public:
        ...
        virtual void CreateShader(BYTE *pShaderCode, uint32 shaderCodeSize, ShaderParam *pShaderParams, uint32 shaderParamSize, IShader **ppShader) override;
    };
}
